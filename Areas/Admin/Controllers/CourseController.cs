...
namespace EduFlex.Areas.Admin.Controllers
{
    ...
    public class CourseController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewBag.Instructors = new SelectList(_context.Users.Where(u => u.IsActive), "UserId", "FullName");
        ...
        public IActionResult Create(Course course, IFormFile? courseFile)
        {
            ...
            {
                ViewBag.Categories = new SelectList(_context.Categories.Where(c => c.IsActive), "CategoryId", "CategoryName", course.CategoryId);
                ViewBag.Instructors = new SelectList(_context.Users.Where(u => u.IsActive), "UserId", "FullName", course.InstructorId);
        ...
        public IActionResult Edit(int id, Course updatedCourse, IFormFile? courseFile)
        {
            ...
            if (!ModelState.IsValid)
            {
                ViewBag.Categories = new SelectList(_context.Categories.Where(c => c.IsActive), "CategoryId", "CategoryName", updatedCourse.CategoryId);
                ViewBag.Instructors = new SelectList(_context.Users.Where(u => u.IsActive), "UserId", "FullName", updatedCourse.InstructorId);
